...
const CurrentWeather = ({
  ...
  const items = [
    ...
    },
    {
      ...
      /* rain drops — distinct from the humidity water drop */
      icon:
        <GrainRounded />,
    },
    {
    ...
    },
    {
      ...
      /* sunshine hours — distinct from the UV index sun */
      icon:
        <WbTwilightRounded />,
    },
  ];
            ...
            >
              ...
              >
                ...
                <Box
                  component="span"
                  sx={{
                    /* readable in both themes (the old #8995A7 only
                       reached 2.9:1 on the light surface) */
                    color: softText,
                    fontWeight: 600,
                    fontSize:
                      "0.85rem",
